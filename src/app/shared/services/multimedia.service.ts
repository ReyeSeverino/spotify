...
export class MultimediaService {
  ...
  private setTimeElapsed(currentTime: number): void {
    ...
    const displayMinlutes = (minutes < 10) ? `0${minutes}` : minutes;
    const displayFormat = `${displayMinlutes}: ${displaySeconds}`
  ...
  public seekAudio(percentage: number): void {
    ...
    //TODO 100% ---> (x)
    const percentegeToSecond = (percentage * duration) / 100
    this.audio.currentTime = percentegeToSecond
    //TODO: 🔴 70% ---> second --->
  }
